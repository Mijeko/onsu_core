  ...
  AbstractChosen = (function() {
    ...
    AbstractChosen.prototype.results_option_build = function(options) {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        if (this.form_field[_i].getAttribute('data-sup') !== null ) {
          data.withSup = this.form_field[_i].getAttribute('data-sup');
        }
        if (data.group) {
    ...
    AbstractChosen.prototype.result_add_option = function(option) {
      var classes, option_el, img_el, title_el, sup_el;
      ...
      console.log( option.withSup)
      if ( typeof option.withSup !== 'undefined' ) {
        sup_el = document.createElement("sup");
        sup_el.innerHTML = option.withSup;
        option_el.appendChild(sup_el);
      }
  ...
  Chosen = (function(_super) {
    ...
    Chosen.prototype.single_set_selected_text = function(text, img) {
      ...
      if ( typeof img !== 'undefined' ) {
        var img_el = document.createElement("sup");
      }
