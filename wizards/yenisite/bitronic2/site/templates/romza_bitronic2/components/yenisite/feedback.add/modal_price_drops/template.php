    ...
    <div class="modal-dialog">
        ...
        <form data-toggle="validator" method="post" action="#" data-rzoption="captcha-when-price-drops"
            ...
            <? if ($isAjax): ?>
                ...
                <input type="hidden" name="ITEM_PRICE" value="<?= $_REQUEST['PRICE'] ?: htmlspecialcharsbx($_REQUEST['ITEM_PRICE']) ?>"/>
                ...
                <div>
                    ...
                    <label class="textinput-wrapper price">
                        ...
                        <span class="currency">
                            <? $currency = $_REQUEST['CURRENCY'] ?: htmlspecialcharsbx($_REQUEST[$arResult['CODE']]['CURRENCY'])?>
                            <? $price = $_REQUEST['PRICE'] ?: htmlspecialcharsbx($_REQUEST[$arResult['CODE']]['PRICE'])?>
                            <? $curPrice = $_REQUEST['PRICE'] ?: htmlspecialcharsbx($_REQUEST['ITEM_PRICE'])?>
