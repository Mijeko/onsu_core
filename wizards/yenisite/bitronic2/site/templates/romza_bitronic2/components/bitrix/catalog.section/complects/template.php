...
?>
<div id="complects-to-<?=$arParams['ELEMENT_ID']?>" itemprop="isRelatedTo" itemscope itemtype="https://schema.org/Product" class="buy-block-additional">
	<header>
        <i class="flaticon-package6"></i>
        <span class="text"><?=$arParams['~HEADER_TEXT']?></span>
    </header>
    <div class="complect-list">
		<? foreach($arResult['ITEMS'] as $arItem):
				...
				?><div class="complect-item full <?=(!$arItem['CAN_BUY'] && !$arItem['ON_REQUEST'] ? ' out-of-stock' : '')?> catalog-item" id="<?=$arItemIDs['ID']?>">
                     <div class="complect-wrap">
                         ...
                         <div class="content-wrap">
                            <a href="<?=$arItem['DETAIL_PAGE_URL']?>" class="name link" data-product-id="<?=$arItem['ID']?>">
