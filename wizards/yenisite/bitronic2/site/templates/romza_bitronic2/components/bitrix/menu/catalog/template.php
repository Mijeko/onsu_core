...
$bShowFirstLvImg = $arParams['SHOW_FIRST_LVL_IMG'] == 'Y';
$bShowSecondLvImg = $arParams['SHOW_SECOND_LVL_IMG'] == 'Y';
$bShowThirdLvImg = $arParams['SHOW_THIRD_LVL_IMG'] == 'Y';
$bOpenMenu = $arParams['OPEN_MENU'] && $arParams['IN_CATALOG'];
...
<nav itemscope itemtype="http://schema.org/SiteNavigationElement" class="catalog-menu mainmenu" id="mainmenu"<?if($arParams['HITS_POSITION'] === 'BOTTOM'):?> data-menu-opened="<?=$bOpenMenu ? 'false' : 'true'?>" data-menu-hits-pos="bottom"<?endif?>
		...
		<div class="catalog-menu-lvl0 main">
			<?foreach($arResult["ALL_ITEMS_ID"] as $idItem_1=>$arItem_1):?>
				...
				<div class="catalog-menu-lvl0-item<?= $bCnt ? '' : ' no-numbers' ?>"><?
					...
					$bImg = !empty($img) && $arParams['SHOW_ICONS'] && $bShowFirstLvImg;?>
					...
					<div class="submenu-wrap">
						...
						<div class="catalog-menu-lvl1-content">
							...
							<div class="catalog-menu-lvl1">
								...
								$bImg = !empty($img) && $arParams['SHOW_ICONS'] && $bShowSecondLvImg;
								...
								<ul>
									...
									$bImg = !empty($img) && $arParams['SHOW_ICONS'] && $bShowThirdLvImg;
