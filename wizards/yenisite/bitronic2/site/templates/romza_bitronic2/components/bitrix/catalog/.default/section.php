...
define("IN_CATALOG_LIST",true);

$this->setFrameMode(true);
if (defined("ERROR_404")) return;
global $rz_b2_options, $rz_current_sectionID;
$bCanonical = $arParams['SET_CANONICAL_FOR_SECTION'] != 'N';
...
if ($bCanonical) {
    ...
    $APPLICATION->SetPageProperty('canonical', $protocol . SITE_SERVER_NAME . $arResult['FOLDER']. $arCurSection['SECTION_PAGE_URL']);
}

$bShowFirstLvlOfCatalog = $rz_b2_options['use_lvl_first'] == 'Y' && $arCurSection['DEPTH_LEVEL'] == 1;
...
if ($bShowFirstLvlOfCatalog && $arCurSection['HAS_SUB_SECTIONS']):
    include 'include/sections_list_in_lvl_first.php';
    return;
endif;
...
if ('Y' === $rz_b2_options['use_reviews']) {
    ...
    <div class="row">
                ...
                if ('Y' == $arParams['USE_FILTER']) {
                    if ($_GET['ajax'] == 'y' && isset($_SERVER['HTTP_BX_AJAX'])) {
                        ...
                        if ('Y' == $rz_b2_options['block_show_ad_banners']) {
                           include 'include/banners-top.php';
                        }
                        include 'include/filter.php';
                    }
                }
        ...
        <div class="catalog-main-content col-sm-12 col-md-9 col-xxl-10">
            ...
            */ ?>
            ...
            $dynamicArea->setAnimation(true);
            $dynamicArea->startDynamicArea();
            if ($rz_b2_options['use_reviews'] == 'Y' && $_REQUEST['rz_ajax'] !== 'y' && Bitrix\Main\Loader::includeModule('iblock')) {
            ...
            <? endif ?>
            <div id="<?=$arResult['FILTER_PLACE'] == 'top' ? 'filter-at-top' : 'filter-at-line'?>">
                <?
                if ('Y' == $arParams['USE_FILTER'] && ($arResult['FILTER_PLACE'] == 'top'  || $arResult['FILTER_PLACE'] == 'line')) {
                    if ('Y' == $rz_b2_options['block_show_ad_banners']) {
            ...
            */
            ...
            ?>
            <?include "include/banners-bottom.php"?>
