...
$arResult['HOVER-MODE'] = Mobile::isMobile() ? 'border-n-shadow' : $rz_b2_options['product-hover-effect'];
...
$arParams['PRODUCT_DISPLAY_MODE_SECTION'] = $rz_b2_options['sku-view-section'];
$arParams['PRODUCT_DISPLAY_MODE_DETAIL'] = $rz_b2_options['sku-view'];
...
if (!is_array($arParams['PROPS_FOR_SKU_TABLE'])) $arParams['PROPS_FOR_SKU_TABLE'] = array();
