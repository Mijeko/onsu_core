...
<?$this->SetViewTarget('bitronic2_modal_register');*/?>
		<form data-toggle="validator" method="post" action="<?=$arResult["AUTH_URL"]?>" name="bform" enctype="multipart/form-data" class="form_registration" id="modal_form_registration">
			...
			*/?>
			...
			<?endif;?>
            <?if (!$bSuccesRegistration && CRZBitronic2CatalogUtils::checkGoogleCaptchaShow() && $rz_b2_options['captcha-registration'] == 'Y'):?>
                <label class="textinput-wrapper">
