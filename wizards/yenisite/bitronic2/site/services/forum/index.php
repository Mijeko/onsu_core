...
$arForums = Array(
	Array(
		...
		"NAME" => GetMessage("BITRONIC2_REVIEWS_FORUM_NAME"),
		"DESCRIPTION" => GetMessage("BITRONIC2_REVIEWS_FORUM_DESCRIPTION"),
		"SORT" => 2,
		"ACTIVE" => "Y",
		"ALLOW_HTML" => "N",
		"ALLOW_ANCHOR" => "Y",
...
{
	$dbForum = CForumNew::GetList(Array(), Array("SITE_ID" => WIZARD_SITE_ID, "TEXT" => $arForum["DESCRIPTION"]));
	if ($dbForum->Fetch())
	{
		continue;
	}
...
$reviewsForumID = 0;
$dbRes = CForumNew::GetListEx(array(), array("SITE_ID" => WIZARD_SITE_ID, "TEXT" => "BITRONIC2"));
