...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/{$moduleCode}_news.xml"; 
$iblockCode = "{$moduleCode}_news";
$iblockType = "news"; 
...
if(strlen($lang) <= 0)
	...
	//SET MESSAGES
	$arMessages = array(
		'ELEMENT_NAME' 		=> GetMessage('NEWS-ELEMENT_NAME'),
		'ELEMENTS_NAME' 	=> GetMessage('NEWS-ELEMENTS_NAME'),
		'ELEMENT_ADD' 		=> GetMessage('NEWS-ELEMENT_ADD'),
		'ELEMENT_EDIT' 		=> GetMessage('NEWS-ELEMENT_EDIT'),
		'ELEMENT_DELETE' 	=> GetMessage('NEWS-ELEMENT_DELETE'),
		'SECTION_NAME' 		=> GetMessage('NEWS-SECTION_NAME'),
		'SECTIONS_NAME' 	=> GetMessage('NEWS-SECTIONS_NAME'),
		'SECTION_ADD' 		=> GetMessage('NEWS-SECTION_ADD'),
		'SECTION_EDIT' 		=> GetMessage('NEWS-SECTION_EDIT'),
		'SECTION_DELETE' 	=> GetMessage('NEWS-SECTION_DELETE'),
	);
