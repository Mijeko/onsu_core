									...
									case 'priceRanges':
										if ($arParams['USE_PRICE_COUNT'])
										{
											...
											<div class="product-item-detail-info-container"
												...
												<div class="product-item-detail-info-container-title"><?=$arParams['MESS_PRICE_RANGES_TITLE']?></div>
											...
											<?
											unset($showRanges, $itemPrice, $range);
										}
					...
					<div class="col-xs-12">
						...
						if ($showDescription)
						{
							...
							<div class="product-item-detail-tab-content active" data-entity="tab-container" data-value="description"
								...
								{
									echo 'Test ' . $arResult['PREVIEW_TEXT_TYPE'] === 'html' ? $arResult['PREVIEW_TEXT'] : '<p>'.$arResult['PREVIEW_TEXT'].'</p>';
								}
