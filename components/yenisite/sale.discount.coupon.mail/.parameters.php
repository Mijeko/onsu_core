	...
	"PARAMETERS" => array(
		...
		'COUPON_TYPE' => array(
			...
			"VALUES" => Array(
                ...
                "Reuse" => GetMessage("SBP_PARAMETERS_COUPON_TYPE_REUSABLE"),
			),
			"DEFAULT" => "Reuse",
		),
        ...
        "UNREGISTERED_USER" => [
            "PARENT" => "REPL_SETT",
            "NAME" => GetMessage("SBP_PARAMETERS_REPL_SETT_UNREGISTERED_USER"),
            "TYPE" => "CHECKBOX",
            "DEFAULT" => "N",
            "REFRESH" => "N"
        ],
        "COUNT_OF_ORDER" => [
            "PARENT" => "REPL_SETT",
            "NAME" => GetMessage("SBP_PARAMETERS_REPL_SETT_COUNT_ORDER"),
            "TYPE" => "STRING",
            "DEFAULT" => 5
        ],
	),
