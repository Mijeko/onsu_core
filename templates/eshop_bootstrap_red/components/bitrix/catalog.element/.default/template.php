                        ...
                        switch ($blockName) {
                            ...
                            case 'price':?>
                                <div class="product-item-detail-info-container">
                                    ...
                                    <?}?>
                                    <div class="product-item-detail-price-current" id="<?=$itemIds['PRICE_ID']?>" style="text-align: center">
                                        <? //echo $price['PRINT_RATIO_PRICE']?>
                                        <?= $price['BASE_PRICE']?> руб/<?= $actualItem['ITEM_MEASURE']['TITLE']?>
                                    </div>
                                    <?
                                    //var_dump($price);
                                    if ($arParams['SHOW_OLD_PRICE'] === 'Y') {?>
                                    ...
                                    <div class="product-item-detail-info-container"
                                        ...
                                        <div class="product-item-detail-info-container-title">
                                            ...
                                            <span data-entity="price-ranges-ratio-header">
                                                (<?=(Loc::getMessage('CT_BCE_CATALOG_RATIO_PRICE',
...
<script>
	BX.message({
		...
		SITE_ID: '<?=SITE_ID?>',
        MEASURE: '<?=$actualItem['ITEM_MEASURE']['TITLE']?>' //передаем в скрипт строку с единицей измерения
	});
