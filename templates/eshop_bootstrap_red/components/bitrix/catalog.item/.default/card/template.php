...
// Основной шаблон для элементов каталога
...
<div class="product-item">
    <a class="product-item-image-wrapper" href="<?=$item['DETAIL_PAGE_URL']?>" title="<?=$imgTitle?>"
		...
		<span class="product-item-image-original" id="<?=$itemIds['PICT']?>"
              style="background-image: url(<?= !empty($item['PREVIEW_PICTURE_SECOND'])
                ? $item['PREVIEW_PICTURE_SECOND']['SRC']
                : $item['PREVIEW_PICTURE']['SRC']?>); display: <?=($showSlider ? 'none' : '')?>;">
		</span>
		<? if ($item['SECOND_PICT']) {
						...
						<span class="product-item-price-current" id="<?=$itemIds['PRICE']?>">
							<? if (!empty($price)) {
								if ($arParams['PRODUCT_DISPLAY_MODE'] === 'N' && $haveOffers) {
									...
									echo $price['BASE_PRICE'] . ' руб/' . $actualItem['ITEM_MEASURE']['TITLE'];
									//var_dump($price);
								}
							} ?>
						</span>
								...
								<div class="product-item-amount">
									<div class="product-item-amount-field-container">
										...
										<span class="product-item-amount-description-container">
                                            ...
                                            <span id="<?=$itemIds['PRICE_TOTAL']?>"> на сумму <strong><?= $price['PRINT_RATIO_PRICE']?></strong></span>
										</span>
									</div>
								</div>
							</div>
...
<script>
BX.message({
    MEASURE: '<?= $actualItem['ITEM_MEASURE']['TITLE'] ?>'
});
</script>