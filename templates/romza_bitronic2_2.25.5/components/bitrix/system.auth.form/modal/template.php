...
<div class="modal fade modal-form modal_login" id="modal_login" tabindex="-1">
	<div class="modal-dialog">
		...
		if (!$USER->IsAuthorized()):?>
		<form data-toggle="validator" name="system_auth_form<?=$arResult["RND"]?>" method="post" target="_top" action="<?=$arResult["AUTH_URL"]?>" class="form_login">
            ...
            <?elseif ($rz_b2_options['show_google_captcha_in_auth'] == 'Y' && CRZBitronic2CatalogUtils::checkGoogleCaptchaShow()):?>
                <label class="textinput-wrapper">
