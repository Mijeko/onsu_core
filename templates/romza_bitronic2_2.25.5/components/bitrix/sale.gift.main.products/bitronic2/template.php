...
?>
<div id="<?= $injectId ?>" class="similar-products gift-slider bx_sale_gift_main_products">
<?
...
BX(function () {
	...
	if (BX.Sale['GiftMainProductsClass_<?= $component->getComponentId() ?>'].isGift) {
		...
		if ($amGift.length < 1) {
			$amGift = $('<div class="gifts-stickers-wrapper"><span class="sticker-wrapper i-gift flaticon-6-2"  data-tooltip title="<?=GetMessage('BITRONIC2_GIFTS_TO_PRODUCTS')?>"><span class="text"> <?=GetMessage("BITRONIC2_GIFTS_STICKER_TEXT")?></span></span></div>');
