...
$arTemplateParameters_resizer = array(
    ...
    "RESIZER_DETAIL_SKU_TABLE" => array(
		"PARENT" => "RESIZER_SETS",
		"NAME" => GetMessage("RESIZER_DETAIL_SKU_TABLE"),
		"TYPE" => "LIST",
		"VALUES" => $resizer_sets_list,
		"DEFAULT" => "6"
	),
    ...
    "RESIZER_SECTIONS_LVL_FIRST" => array(
		"PARENT" => "RESIZER_SECTIONS_LVL_FIRST",
		"NAME" => GetMessage("RESIZER_SECTIONS_LVL_FIRST"),
		"TYPE" => "LIST",
		"VALUES" => $resizer_sets_list,
		"DEFAULT" => "5"
	),
...
$arTemplateParameters_section = array(
    ...
    "SET_CANONICAL_FOR_SECTION" => array(
        "PARENT" => "LIST_SETTINGS",
        "NAME" 	 => GetMessage('SET_CANONICAL_FOR_SECTION'),
        "TYPE"	 => "CHECKBOX",
        "DEFAULT" => 'Y',
    ),
    "GET_PARENT_SECTION_SERVICES" => array(
        "PARENT" => "LIST_SETTINGS",
        "NAME" 	 => GetMessage('GET_PARENT_SECTION_SERVICES'),
        "TYPE"	 => "CHECKBOX",
        "DEFAULT" => 'N',
    ),
);
...
if ($boolSKU)
{
	...
	$arTemplateParameters_sku = array(
        ...
        'HIDE_DISABLED_PROPS_OF_OFFERS' => array(
			'PARENT' => 'OFFERS_SETTINGS',
			'NAME' => GetMessage('HIDE_DISABLED_PROPS_OF_OFFERS'),
			'TYPE' => 'CHECKBOX',
			'DEFAULT' => 'N',
			'REFRESH' => 'N'
		)
...
$arTemplateParameters_detail = array(
    ...
    'PROPS_FOR_SKU_TABLE' => array(
		"PARENT" => "DETAIL_SETTINGS",
		"NAME" => GetMessage("PROPS_FOR_SKU_TABLE"),
		"TYPE" => "LIST",
		"MULTIPLE" => "Y",
		"VALUES" => $arPropsWithServiceProps,
		"SIZE" => "8",
    ...
    'DETAIL_TITLE_TAB_DESCRIPTION' => array(
		'PARENT' => 'DETAIL_SETTINGS',
		'NAME' => GetMessage('DETAIL_TITLE_TAB_DESCRIPTION'),
		'TYPE' => 'TEXT',
		'DEFAULT' => GetMessage('BITRONIC2_DESCRIPTION')
	),
