...
<? foreach ($arResult['ITEMS'] as $arItem):
    ...
    $availableOnRequest = $arItem['bOffers'] && empty($arItem['OFFERS']) ? false : $availableOnRequest;
    $arItem['CAN_BUY'] = (
    $arItem['bOffers'] && $bSkuExt
    ...
    #BANNER_PLACE#
<?endif ?>
    <div data-item-id="<?=$arItem['ID']?>" itemscope itemtype="http://schema.org/Product" class="catalog-item-wrap<?= ($arItem['VIP'] ? ' big-item' : '') ?>" id="<?= $arItemIDs['ID'] ?>">
        <div class="catalog-item list-item wow fadeIn">
            <div class="photo-wrap <?= !$arItem['SHOW_SLIDER'] ? ' no-thumbs' : '' ?>">
                ...
                <?php include "include/thumbs.php"?>
            </div><!-- /.photo-wrap -->
            <div class="main-data">
                <div class="name">
