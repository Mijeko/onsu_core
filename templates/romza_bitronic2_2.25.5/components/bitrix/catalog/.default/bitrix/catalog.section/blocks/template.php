...
foreach ($arResult['ITEMS'] as $key => $arItem):
    ...
    #BANNER_PLACE#
<? endif ?>
    <div data-item-id="<?=$arItem['ID']?>" itemscope itemtype="http://schema.org/Product"
        ...
        <div class="catalog-item blocks-item wow fadeIn">
            <div class="photo-wrap <?= !$arItem['SHOW_SLIDER'] ? ' no-thumbs' : '' ?>">
                <div itemscope itemtype="http://schema.org/ImageObject" class="photo">
                    <a <?=$arItem['MORE_PHOTO_COUNT'] <= 1 ? 'class="not-hover-photo"' : ''?> title="<?= $imgTitle ?>" href="<?= $arItem['DETAIL_PAGE_URL'] ?>">
                        ...
                        <?if ($arParams['SHOW_HOVER_PHOTO']):?>
                            <?CRZBitronic2CatalogUtils::showSecondHoverImg($arItem, $arItem['VIP'] ? $arParams['RESIZER_SECTION_VIP'] : $arParams['RESIZER_SECTION'])?>
                        <?endif?>
                    </a><?
                    if (!$bSkuExt):
                        if ($bCatchbuy):?>
                ...
                <?include "include/thumbs.php"?>
            </div><!-- /.photo-wrap -->
            <div class="main-data">
                <div class="name">
                    <a itemprop="url" href="<?= $arItem['DETAIL_PAGE_URL'] ?>" class="link <?= $arItemCLASSes['LINK'] ?>"><span itemprop="name"
