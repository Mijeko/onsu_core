function initModalSettings(){
	...
	$('.settings-to-defaults').click(function(){
		...
		//set def color
		form.find('.setting-content.theme-demos li').removeClass('active');
		form.find('.setting-content.theme-demos li[data-default]').addClass('active').click();
        b2.init.selects(form);
