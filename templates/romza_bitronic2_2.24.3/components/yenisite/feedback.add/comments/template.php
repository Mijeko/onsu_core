...
<div class="form-wrap">
	...
	<form data-toggle="validator" method="POST" id="ys-guestbook" name="guestbook" action="<?=$APPLICATION->GetCurPageParam()?>" enctype="multipart/form-data" class="form_comment">
        ...
        <i class="flaticon-check14"></i><?=GetMessage('BITRONIC2_I_ACCEPT')?>
            ...
            <div class="form-footer">
                ...
                <?if ($arParams['USE_GOOGLE_CAPTCHA'] == 'Y' &&  CRZBitronic2CatalogUtils::checkGoogleCaptchaShow()):?>
                    <label class="textinput-wrapper google-captcha-wrap">
