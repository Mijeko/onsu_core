...
if (isset($arResult['SUCCESS']))
{
	...
	if ($arParams['ALLOW_AUTO_REGISTER'] == 'Y' && !empty($arResult['AUTH']['NEW_LOGIN'])){
	    ?>
...
?>
<form data-toggle="validator" method="post" action="<?= $APPLICATION->GetCurPage(true) ?>" class="form_quick-buy modal-form-w-icons">
	<div class="title-h2"><span class="header-text"><?=GetMessage('BITRONIC2_ONECLICK_TITLE')?></span></div>
	...
	<? if ($arParams['FIELD_QUANTITY'] == 'Y' && $_REQUEST['RZ_BASKET'] !== 'Y'): ?>
		<div>
			...
			<div class="textinput-wrapper quantity">
                ...
                <div class="quantity-counter">
                    <div class="quantity-wrap">
                        ...
                        <input type="text" min="0" class="quantity-input textinput" name="QUANTITY" value="<?= $arResult['QUANTITY'] ?>" title=""/>
