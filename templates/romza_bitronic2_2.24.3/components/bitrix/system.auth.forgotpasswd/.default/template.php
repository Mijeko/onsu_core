...
<form data-toggle="validator" name="bform" method="post" target="_top" action="<?=$arResult["AUTH_URL"]?>" class="form_forgot-pass">
...
?>
    ...
    <?endif?>
    <?/*if (CRZBitronic2CatalogUtils::checkGoogleCaptchaShow()):?>
        <label class="textinput-wrapper">
