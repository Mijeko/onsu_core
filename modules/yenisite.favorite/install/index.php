...
class yenisite_favorite extends CModule {
	var $MODULE_ID = "yenisite.favorite";
	var	$PREFIX;
	var	$VENDOR;
	var	$MODULE_VERSION;
	...
	function InstallEvents() {
		//RegisterModuleDependences("main", "On...", $this->MODULE_ID, "YNS...", "On...", 10000);
		return true;
	}

	function UnInstallEvents() {
		//UnRegisterModuleDependences("main", "On...", $this->MODULE_ID, "YNS...", "On...", 10000);
		return true;
	}
	...
	function InstallDemo() {
		...
		$arErr = \Yenisite\Favorite\Favorite::getErrors();
		if (count($arErr) > 0) {
	...
	function UnInstallFiles() {
		...
		//DeleteDirFilesEx('/bitrix/components/' . $this->VENDOR. '/' . $this->MODULE_ID . '/');
	}
