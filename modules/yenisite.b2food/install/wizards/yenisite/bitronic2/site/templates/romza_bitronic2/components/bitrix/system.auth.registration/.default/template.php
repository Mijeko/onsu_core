...
<?endif?>
<form data-toggle="validator" method="post" action="<?=$arResult["AUTH_URL"]?>" name="bform" class="form_forgot-pass">
<?
...
?>
	...
	<?endif?>
    <?if (CRZBitronic2CatalogUtils::checkGoogleCaptchaShow() && $rz_b2_options['captcha-registration'] == 'Y'):?>
        <label>
