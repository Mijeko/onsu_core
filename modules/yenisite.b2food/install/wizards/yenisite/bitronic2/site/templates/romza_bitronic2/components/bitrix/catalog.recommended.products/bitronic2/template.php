...
?>
<div itemprop="isRelatedTo" itemscope itemtype="https://schema.org/Product" class="viewed-products<?= $bHoverMode ? ' __expanded' : '' ?> <?=$arParams['ORDER_DETAIL_BLOCKS'] ? "drag-section ".$arParams['NAME_ORDER_BLOCK'] : ''?>" <?=$arParams['ORDER_DETAIL_BLOCKS'] ? "data-order=\"{$arParams['ORDER_DETAIL_BLOCKS']}\"" : ''?> id="viewed-products-recommended">
