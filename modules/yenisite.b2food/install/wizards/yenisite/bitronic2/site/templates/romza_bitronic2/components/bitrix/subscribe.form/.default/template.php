...
?>
<form data-toggle="validator" action="<?= $arResult["FORM_ACTION"] ?>" class="form_footer-subscribe">
	<div class="hidden">
...
<form data-toggle="validator" action="<?= $arResult["FORM_ACTION"] ?>" class="form_footer-subscribe">
	...
	<div class="textinput-wrapper">
		<input required type="email" class="textinput" name="sf_EMAIL" size="20" value="" title="<?= GetMessage("subscr_form_email_title") ?>"
		       placeholder="<?= GetMessage("subscr_form_email_title") ?>"/>
	</div>
	<button type="submit" class="btn-main" name="OK"><?= GetMessage("subscr_form_button") ?></button>
</form>
<?
$frame->end();
?>
