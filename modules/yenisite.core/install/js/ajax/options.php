...
IncludeModuleLangFile($_SERVER["DOCUMENT_ROOT"] . BX_ROOT . "/modules/yenisite.core/options.php");
$arResult = array(
    'success' => false,
...
switch ($_REQUEST['ACTION']) {
    ...
    case 'GET_IBLOCK_DIRECTORY_PROPS':
        ...
        foreach ($arIBlocks as $arIBlock) {
			...
			<td valign="bottom" class="adm-detail-content-cell-r"><select id="color_guess_prop_'.$arIBlock['ID'].'" name="color_guess_prop_'.$_REQUEST['SITE_ID'].$arIBlock['ID'].'">';
