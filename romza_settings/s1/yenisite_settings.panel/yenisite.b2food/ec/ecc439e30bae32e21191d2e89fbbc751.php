...
[data-theme-button="black"] .benefit.openness .img-wrap {
  background: url("pictures/benefits/agree.png") center center, red;
  background-size: 60%; }

[data-theme-button="black"] .benefit.warranty .img-wrap {
  background: url("pictures/benefits/OK.png") center center, red;
  background-size: 60%; }

[data-theme-button="black"] .benefit.delivery .img-wrap {
  background: url("pictures/benefits/delivery.png") center center, red;
  background-size: 60%; }

[data-theme-button="black"] .benefit.profit .img-wrap {
  background: url("pictures/benefits/sale.png") center center, red;
  background-size: 60%; }

[data-theme-button="black"] .benefit.exchange .img-wrap {
  background: url("pictures/benefits/exchange.png") center center, red;
  background-size: 50%; }

[data-theme-button="black"] .benefit.bigstock .img-wrap {
  background: url("pictures/benefits/menu.png") center center, red;
  background-size: 50%; }
