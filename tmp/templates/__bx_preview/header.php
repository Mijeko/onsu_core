...
<html lang="<?= LANGUAGE_ID ?>">
    <head>
        ...
        <meta name="yandex-verification" content="aceeac8b8a5adfc4" />
        ...
        <script type='application/ld+json'>
            {
                ...
                "@type": "Organization",
                "name": "Provianta.ru",
                "url": "http://provianta.ru",
                "logo": "http://provianta.ru/bitrix/templates/romza_bitronic2_2.23.13/pictures/benefits/delivery.png",
                "description": "Мясные деликатесы, колбасы, замороженные полуфабрикаты и свежее мясо с доставкой на дом! Действуют акции!",
                "address": {
                    "@type": "PostalAddress",
                    "streetAddress": "Машиностроителей 24",
...
<? endif ?>
    ...
    <header class="page-header" data-sitenav-type="<?= $rz_b2_options['header-version'] ?>"
            ...
            style="background: url(<?=SITE_TEMPLATE_PATH?>/img/bg/bg_header4.png) no-repeat;
            background-size: 100%">
        ...
        <div class="container">
            <div class="header-main-content <?= CRZBitronic2Settings::isPro() ? 'with-delivery' : '' ?>">
                ...
                <div class="header-contacts">
                    ...
                    <div class="contacts-content" style="background: <?= $rz_b2_options['color-header']?> ;
                         z-index: 1">
                    ...
                    <div class="call-order">Заказать звонок</div>
                </div><!-- header-contacts -->
