        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-6 col-md-3">
                    <? $APPLICATION->IncludeComponent("bitrix:main.include", "", array_merge($arDefIncludeParams, ["PATH" => SITE_DIR . "include_areas/footer/menu_bottom_title.php"]), false, ["HIDE_ICONS" => "N"]); ?>
                    <nav class="sitenav vertical" id="sitenav-footer">
                        <? $APPLICATION->IncludeComponent("bitrix:main.include", "", array_merge($arDefIncludeParams, ["PATH" => SITE_DIR . "include_areas/footer/menu_bottom.php"]), false, ["HIDE_ICONS" => "Y"]); ?>
                    </nav>
                    <? $APPLICATION->IncludeComponent("bitrix:main.include", "", array_merge($arDefIncludeParams, ["PATH" => SITE_DIR . "include_areas/footer/feedback_text.php"]), false, ["HIDE_ICONS" => "Y"]); ?>
                    <div class="yamarket">
                        <? //$APPLICATION->IncludeComponent("bitrix:main.include", "", array_merge($arDefIncludeParams, ["PATH" => SITE_DIR . "include_areas/footer/ym_reviews.php"]), false, ["HIDE_ICONS" => "N"]); ?>
                    </div>
                </div>
                <div class="col-sm-6 col-md-3">
                    <? $APPLICATION->IncludeComponent("bitrix:main.include", "", array_merge($arDefIncludeParams, ["PATH" => SITE_DIR . "include_areas/footer/menu_catalog.php"]), false, ["HIDE_ICONS" => "Y"]); ?>
                ...
                <div class="col-md-6 col-sm-12">
                    <?
                    //$APPLICATION->IncludeComponent("bitrix:main.include", "", array_merge($arDefIncludeParams, ["PATH" => SITE_DIR . "include_areas/footer/subscribe.php"]), false, ["HIDE_ICONS" => "N"]);
                    $APPLICATION->IncludeComponent("bitrix:main.include", "", array_merge($arDefIncludeParams, ["PATH" => SITE_DIR . "include_areas/footer/socserv.php"]), false, ["HIDE_ICONS" => "N"]);
                    $APPLICATION->IncludeComponent("bitrix:main.include", "", array_merge($arDefIncludeParams, ["PATH" => SITE_DIR . "include_areas/footer/contact_info_title.php"]), false, ["HIDE_ICONS" => "N"]);
                    $pf = '';
                    ...
                    Tools::includePostfixArea($pf, SITE_DIR . "include_areas/footer/phone.php", true);
                    Tools::includePostfixArea($pf, SITE_DIR . "include_areas/footer/email.php", true);
                    ?>
                </div>
                <div class="col-xs-12 payment-systems">
                    <?
                    //$APPLICATION->IncludeComponent("bitrix:main.include", "", array_merge($arDefIncludeParams, ["PATH" => SITE_DIR . "include_areas/footer/payment_systems.php"]), false, ["HIDE_ICONS" => "N"]);
                    //$APPLICATION->IncludeComponent("bitrix:main.include", "", array_merge($arDefIncludeParams, ["PATH" => SITE_DIR . "include_areas/footer/payment_systems_info.php"]), false, ["HIDE_ICONS" => "N"]);
                    ?>
                </div>
            </div><!-- /.row -->
        </div><!-- /.container -->
    </div><!-- /.footer-top -->
    <?php // $rz_b2_options['color-footer'] содержит строку фона для футера ?>
    <div class="footer-middle wow fadeIn"
         style="background: url(<?= SITE_TEMPLATE_PATH ?>/img/bg/bg_footer1.jpg) no-repeat;
                 background-size: 100%;
                 color: <?= $rz_b2_options['color-footer-font'] ?>;
    ...
    <div class="footer-bottom wow fadeIn" data-wow-offset="0">
        <div class="container clearfix">
            <div class="copyright">
                ...
                //$APPLICATION->IncludeComponent("bitrix:main.include", "", array_merge($arDefIncludeParams, array("PATH" => SITE_DIR . "include_areas/footer/attribution.php")), false, array("HIDE_ICONS" => "N"));
                ?>
