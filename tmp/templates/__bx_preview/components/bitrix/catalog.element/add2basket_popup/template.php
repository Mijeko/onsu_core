...
<div class="title-h2"><?=GetMessage('BITRONIC2_POPUP_ITEM_TITLE')?></div>
    <div class="basket-content">
        <div>Вы можете изменить количество товара на странице корзины</div>
		...
		<div class="main-data">
			<a href="<?=$arResult['DETAIL_PAGE_URL']?>" class="link"><span class="text" style="font-size: x-large"><?=$productTitle?></span></a>
			<div>
