...
$arCommonParams = array(
	...
	'VISUAL' => array(
		...
		'AVAILABLE_INFO' => $arItemIDs['AVAILABILITY'],
		'AVAILABLE_INFO_MOBILE' => $arItemIDs['AVAILABILITY_MOBILE'],
...
if(!$arItem['bOffers'])
{
    ...
    $step_quantity = $arItem['PROPERTIES']['KRATNOST']['VALUE'] ? : $arItem['CATALOG_MEASURE_RATIO'];
    ...
    $arJSParams = array(
		...
		'PRODUCT' => array(
            ...
            'MIN_QUANTITY' => $arItem['PROPERTIES']['MINIMALNYY_ZAKAZ']['VALUE'],
		),
		'BASKET' => array(
...
{
	if ('Y' == $arParams['PRODUCT_DISPLAY_MODE_CUSTOM'] && !empty($arItem['OFFERS_PROP']))
	{
		$arSkuProps = array();
