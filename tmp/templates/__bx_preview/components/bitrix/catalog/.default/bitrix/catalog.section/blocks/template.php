...
<? endif ?>
    <div itemscope itemtype="http://schema.org/Product"
        ...
        <div class="catalog-item blocks-item wow fadeIn">
            ...
            <div class="main-data">
                <div class="name">
                    <a itemprop="url" href="<?= $arItem['DETAIL_PAGE_URL'] ?>" class="link">
                        <span itemprop="name" class="text"><?= $productTitle ?></span>
                    </a>
                </div>
                    ...
                    <? if ('Y' == $arParams['USE_PRODUCT_QUANTITY'] && !$arItem['bOffers'] && $arItem['CAN_BUY'] && (!$bBuyProps || $emptyProductProperties) && $arParams['SHOW_BUY_BTN']): ?>
                        <form action="#" method="post" class="quantity-counter"
                            ...
                            <input type="text" class="quantity-input textinput"
                                   value="<?= $arItem['PROPERTIES']['MINIMALNYY_ZAKAZ']['VALUE'] ? : $arItem['CATALOG_MEASURE_RATIO'] ?>" id="<?= $arItemIDs['QUANTITY'] ?>">
