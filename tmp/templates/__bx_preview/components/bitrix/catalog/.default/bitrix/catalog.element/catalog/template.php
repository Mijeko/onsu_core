...
// Заменяем стандартный вывод названия
//$productTitle = (
//isset($arResult["IPROPERTY_VALUES"]["ELEMENT_PAGE_TITLE"]) && $arResult["IPROPERTY_VALUES"]["ELEMENT_PAGE_TITLE"] != ''
//    ? $arResult["IPROPERTY_VALUES"]["ELEMENT_PAGE_TITLE"]
//    : $arResult["NAME"]
//);
$productTitle = $arResult["PREVIEW_TEXT"] ?: $arResult["NAME"];
...
?>
<!-- components\bitrix\catalog\.default\bitrix\catalog.element\catalog\template.php -->
...
<? endif; //var_dump($arResult['PROPERTIES']['MINIMALNYY_ZAKAZ']['VALUE']); ?>
                ...
                */
                ...
                <? if (!$arResult['bSkuExt']): ?>
                    ...
                    <div class="gallery-carousel carousel slide" data-interval="0"
                         id="<?= $arItemIDs['SLIDER_CONT_ID'] ?>" style="height:100%; width: 100%">
                        <div class="carousel-inner product-photo">
                            ...
                            <? else: ?>
                                <div class="item active">
                                    <div itemscope itemtype="http://schema.org/ImageObject" class="img-wrap">
                                        <? if (!$arParams['QUICK_VIEW']){ ?>
                                            <span id="img-zoom" class="flaticon-search50"></span>
                                        <?}?>
                                        <img
                                        ...
                                        <? if (!empty($arResult['MORE_PHOTO']['VIDEO']) && $bShowVideoInSlider): ?>
                                            <? foreach ($arResult['MORE_PHOTO']['VIDEO'] as $video): ?>
                                                <div class="thumb has-video">
                                                    <i class="flaticon-movie16" data-video="<?= $video ?>"></i>
                                                </div>
                                            <? endforeach ?>
                                        <? endif ?>
                    ...
                    <div class="buy-block-main<? if (!($bShowEdost && !$arParams['EDOST_PREVIEW'])): ?> __slim<? endif ?>">
                        <div class="buy-block-content">
                            ...
                            <div class="move">
                                            ...
                                            if (empty($availableOnRequest) && 'Y' == $arParams['USE_PRODUCT_QUANTITY']):?>
                                                ...
                                                >
													...
													<button type="button"
                                                            ...
                                                            id="<?= $arItemIDs['QUANTITY_DOWN'] ?>">
                                                        <span class="minus"></span>
                                                    </button>
													<input type="text" class="quantity-input textinput"
                                                           id="<?= $arItemIDs['QUANTITY']; ?>"
                                                           value="<?= $arResult['PROPERTIES']['MINIMALNYY_ZAKAZ']['VALUE'] ? :$arResult['CATALOG_MEASURE_RATIO'] ?>">
													<button type="button" class="btn-silver quantity-change increase"
                                                            id="<?= $arItemIDs['QUANTITY_UP']; ?>">
                                ...
                                <? $txtMySection = $component->__parent->arParams['MY_SECTION_ID'];
                                //echo $txtMySection;
                                if ($txtMySection) {
                                    $arMySection = explode(' ', $txtMySection);
                                    if (in_array($arResult['SECTION']['IBLOCK_SECTION_ID'], $arMySection)
                                        || in_array($arResult['IBLOCK_SECTION_ID'], $arMySection))
                                    { ?>
                                        <div class="txt-exact-weight"> Вес продукта уточняйте у оператора </div>
                                <?} }?>
...
<?= $arParams['DETAIL_INFO_MODE'] == 'tabs' ? ' tabs' : '' ?> <?= empty($availableClass) ? '' : $availableClass ?> drag-section sPrInfAvailability" data-order="<?=$arParams['ORDER_DETAIL_BLOCKS']['order-sPrInfAvailability']?>">
                                    ...
                                    <div class="combo-target-content"
                                        ...
                                        <script type="text/javascript">
                                            ...
                                            <?elseif ($arParams['DETAIL_INFO_MODE'] == 'full'):?>
                                            $('.combo-target.availability.markets-combo .combo-header').click(initTabStores);
                                            <?elseif ($arParams['DETAIL_INFO_MODE'] == 'tabs'):?>
                                            $('.links-wrap .tab-store').click(initTabStores);
                                            <?endif?>
                                        </script>
                                    </div>
                                </div><!-- /.availability -->
