						...
						<span data-picture data-alt="<?=$arItem['PICTURE_PRINT_BIG']['ALT']?>">
							...
							<noscript>
									<img itemprop="contentUrl"
                                        title="<?= $imgTitle ?>"
                                        class="lazy"
                                        data-original="<?=$arItem['PICTURE_PRINT_BIG']['SRC']?>"
                                        src="<?=ConsVar::showLoaderWithTemplatePath()?>"
                                        alt="<?=$arItem['PICTURE_PRINT_BIG']['ALT']?>"
                                    >
							</noscript>
						</span>
					</a>
				...
				<div class="track">
					<?foreach($arResult['ITEMS'] as $arItem):?>
                        ...
                        <div class="ctrl-item <?=($arItem['bFirst']) ? 'active' : ''?>">
							...
							<i class="dot"></i>
							<div class="content" data-tooltip data-container="body" title="<?=$arItem['PREVIEW_TEXT']?>">
								<div itemscope itemtype="http://schema.org/ImageObject" class="img-wrap">
									<span data-picture data-alt="<?=$arItem['PICTURE_PRINT_SMALL']['ALT']?>">
										<span  data-itemprop="contentUrl" data-title="<?=$arItem['PREVIEW_TEXT']?>" data-src="<?=$arItem['PICTURE_PRINT_SMALL']['SRC']?>"></span>
										<span data-src="" data-media="(max-width: 991px)"></span>
										
										<!-- Fallback content for non-JS browsers. Same img src as the initial, unqualified source element. -->
										<noscript>
												<img itemprop="contentUrl" title="<?=$arItem['PREVIEW_TEXT']?>" class="lazy" data-original="<?=$arItem['PICTURE_PRINT_SMALL']['SRC']?>" src="<?=ConsVar::showLoaderWithTemplatePath()?>" alt="<?=$arItem['PICTURE_PRINT_SMALL']['ALT']?>">
										</noscript>
									</span>
								</div>
