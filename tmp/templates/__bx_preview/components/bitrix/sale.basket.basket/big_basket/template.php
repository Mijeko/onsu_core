		...
		<div id="basket_form_container">
            ...
            <? if ($normalShow):?>
				<a href="#basket-big" class="um_tab<?= $normalActive?> basket-btn" id="basket_toolbar_button" data-tab="items">
					...
					<span class="btn-text">
                        <?= GetMessage("BITRONIC2_SALE_BASKET_ITEMS_READY")?>
                        <span class="hidden-xs"><?= GetMessage("BITRONIC2_SALE_BASKET_ITEMS")?></span>
                        (<span class="items-in-basket"><?= $normalCount?></span>)
                    </span>
				</a>
            <? endif; ?>
            <? if ($delayShow):	?>
				<a href="#waitlist-big" class="um_tab<?= $delayActive?> waitlist-btn" id="basket_toolbar_button_delayed" data-tab="delay">
					...
					<span class="btn-text">
                        <?= GetMessage("BITRONIC2_SALE_BASKET_ITEMS_DELAYED")?>
                        <span class="hidden-xs"><?= GetMessage("BITRONIC2_SALE_BASKET_ITEMS")?></span>
            ...
            <? if ($naShow): ?>
				<a href="#nalist-big" class="um_tab<?= $naActive?> waitlist-btn" id="basket_toolbar_button_not_available" data-tab="na">
					...
					<span class="btn-text">
                        <?= GetMessage("BITRONIC2_SALE_BASKET_ITEMS_NOT_AVAILABLE")?>
                        <span class="hidden-xs"><?= GetMessage("BITRONIC2_SALE_BASKET_ITEMS")?></span>
                        (<span class="items-in-nalist"><?= $naCount?></span>)
                    </span>
				</a>
            <? endif; ?>
			</div>
