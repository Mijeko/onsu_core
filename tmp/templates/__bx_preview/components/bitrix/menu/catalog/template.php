...
<nav itemscope itemtype="http://schema.org/SiteNavigationElement" class="catalog-menu mainmenu" id="mainmenu" <?= $arParams['HITS_POSITION'] === 'BOTTOM' ? 'data-menu-hits-pos="bottom"' : '' ?>
							...
							<div class="catalog-menu-lvl1">
								<div class="menu-lvl1-header">
								    ...
								    if ($curPage == $arResult["ALL_ITEMS"][$idItem_2]['LINK']):?>
									    <span class="menu-lvl1-link active"><?if($bImg):?>
                                            <img src="<?=$img?>" alt="<?=$arResult["ALL_ITEMS"][$idItem_2]['TEXT']?>" class="subcategory-img"/><?endif?>
                                            <span class="text"><?=$arResult["ALL_ITEMS"][$idItem_2]['TEXT']?></span>
                                            <? if(is_numeric($arResult["ALL_ITEMS"][$idItem_2]['PARAMS']['ELEMENT_CNT'])): ?>
                                                <sup class="i-number"><?=$arResult["ALL_ITEMS"][$idItem_2]['PARAMS']['ELEMENT_CNT']?></sup>
                                            <? endif ?>
                                        </span>
								    <? else: ?>
									    <a href="<?=$arResult["ALL_ITEMS"][$idItem_2]['LINK']?>" class="menu-lvl1-link <?=($arResult["ALL_ITEMS"][$idItem_2]['SELECTED'] ? 'active' : '')?>">
                                            <?if($bImg):?>
                                                <img src="<?=$img?>" alt="<?=$arResult["ALL_ITEMS"][$idItem_2]['TEXT']?>" class="subcategory-img"/>
                                            <?endif?>
                                            <span class="text"><?=$arResult["ALL_ITEMS"][$idItem_2]['TEXT']?></span>
                                            <?if(is_numeric($arResult["ALL_ITEMS"][$idItem_2]['PARAMS']['ELEMENT_CNT'])):?>
                                                <sup class="i-number"><?=$arResult["ALL_ITEMS"][$idItem_2]['PARAMS']['ELEMENT_CNT']?></sup>
									...
									<? foreach($arItem_2 as $idItem_3):?>
                                        ...
                                        if ($curPage == $arResult["ALL_ITEMS"][$idItem_3]['LINK']):?>
                                            <span class="link active">
                                                <? if($bImg): ?>
                                                    <img src="<?=$img?>" alt="<?=$arResult["ALL_ITEMS"][$idItem_3]['TEXT']?>" class="subcategory-img"/>
                                                <? endif ?>
                                                <span class="text"><?=$arResult["ALL_ITEMS"][$idItem_3]['TEXT']?></span>
                                                <? if(is_numeric($arResult["ALL_ITEMS"][$idItem_3]['PARAMS']['ELEMENT_CNT'])): ?>
                                                    <sup class="i-number"><?=$arResult["ALL_ITEMS"][$idItem_3]['PARAMS']['ELEMENT_CNT']?></sup>
                                                <? endif ?>
                                            </span>
                                        <? else: ?>
                                            <a itemprop="discussionUrl" href="<?=$arResult["ALL_ITEMS"][$idItem_3]['LINK']?>" class="link <?=($arResult["ALL_ITEMS"][$idItem_3]['SELECTED'] ? 'active' : '')?>">
                                                <? if($bImg): ?>
                                                    <img src="<?=$img?>" alt="<?=$arResult["ALL_ITEMS"][$idItem_3]['TEXT']?>" class="subcategory-img"/>
                                                <? endif ?>
                                                <span class="text"><?=$arResult["ALL_ITEMS"][$idItem_3]['TEXT']?></span>
