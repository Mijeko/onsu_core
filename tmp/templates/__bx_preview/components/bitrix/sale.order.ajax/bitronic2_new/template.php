...
$this->addExternalJs(SITE_TEMPLATE_PATH . '/js/custom-scripts/inits/pages/initOrderDetailsPage.js');
//TO DO: $this->addExternalJs(SITE_TEMPLATE_PATH . '/js/3rd-party-libs/jquery.maskedinput.min.js');
?>

	<main class="container order-details-page" data-page="order-handlers-details-page" id="order_form_div">
		<a href="<?= $arParams['PATH_TO_BASKET'] ?>" class="btn btn-return">
			<i class="flaticon-shopping109"></i>
			<span class="text"><?= GetMessage("BITRONIC2_SOA_BACK_TO_BASKET") ?></span>
		</a>
		 <h1><? $APPLICATION->ShowTitle(false) ?></h1>
			...
			<div id="bx-soa-order" class="row bx-<?=$arParams['TEMPLATE_THEME']?>" style="opacity: 0">
				...
				<div class="col-sm-9 bx-soa">
					...
					<!--	ORDER SAVE BLOCK test	-->
                    <? //DiscountCouponsManager::get(true); ?>
