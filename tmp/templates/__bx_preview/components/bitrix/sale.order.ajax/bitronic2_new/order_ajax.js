					...
					onsuccess: BX.delegate(function(result) {
						...
						switch (action)
						{
							...
							case 'enterCoupon':
								...
								{
									//var coupon = result.order.COUPON_LIST[0].COUPON;
									//for (var key in result.order.USER_PROFILES){
									//	var userID = result.order.USER_PROFILES[key].USER_ID;
									//	console.log(userID);
									//	if (userID)	break;
									//}
